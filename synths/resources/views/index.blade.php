...
<head>
    ...
    <!-- Tailwind CSS via CDN (consider installing it properly in Laravel) -->
...
<body
    ...
    <div class="min-h-screen flex items-center justify-center p-8">
        <div
            class="max-w-7xl w-full bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden flex flex-col items-center p-12 animate-fade-in">
            <div class="text-center mb-8 animate-slide-up">
                <!-- Using Laravel asset helper for the image path -->
                <img src="{{ asset('image/ofppt_logo.png') }}" alt="Logo OFPPT"
                    class="w-40 h-auto mb-4 mx-auto hover:scale-105 transition-transform">
                ...
                <p class="text-lg text-secondary dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                    Plateforme de gestion des documents des stagiaires de l'Office de la Formation Professionnelle et de
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 w-full max-w-5xl">
                <div
                    class="group bg-gray-50 dark:bg-gray-700 p-6 rounded-2xl text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div
                        class="text-4xl text-primary dark:text-blue-400 mb-4 group-hover:scale-110 transition-transform">
            ...
            <!-- Using Laravel route helper for the login link -->
            <a href="{{ url('/login') }}"
